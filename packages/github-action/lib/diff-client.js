...
export async function fetchDiffResult(inputs) {
    try {
...
async function previewDiff(inputs) {
...
async function storedDiff(inputs) {
    return ky
...
function previewDiffUrl(inputs) {
...
async function readBackendError(error) {
